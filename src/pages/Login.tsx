...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (username === "ajay" && password === "ajay@205") {
      ...
      toast({
        title: "Login Failed",
        description: "Invalid credentials. Please check username and password.",
        variant: "destructive",
      });
    }
    setIsLoading(false);
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 to-blue-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground bg-amber-50 p-3 rounded-lg">
            <p className="font-medium text-amber-800">Demo Credentials:</p>
            <p>Username: <span className="font-mono">ajay</span></p>
            <p>Password: <span className="font-mono">ajay@205</span></p>
          </div>
        </CardContent>
      </Card>
    </div>
